...
class Postest extends Model
{
    ...
    {
        if (!is_null($id)) {
            return $this->hasOne(PostestUser::class)->where('postest_users.user_id', $id);
        } else {
            return $this->belongsToMany(User::class, 'postest_users', 'postest_id','user_id')->withTimestamps()->withPivot('answer', 'value');
        }
    }
    ...
    {
        if (!is_null($id)) {
            return $this->hasOne(PostestDetail::class)->wherePostestId($id);
        } else {
            $query = $this->hasMany(PostestDetail::class);
            return $query;
        }
    }
