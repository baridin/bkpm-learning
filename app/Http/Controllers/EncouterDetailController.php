...
class EncouterDetailController extends VController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $encouterDetail = EncouterDetail::find($id);
        if (!empty($encouterDetail->id)) {
            $encouterDetail->update([
                'type' => $request->type,
                'value' => $request->value,
                'details' => $request->type === 'pg' ? json_encode([
        ...
        return redirect()
        ->route("voyager.encouters.edit", $request->encouter_id)
        ->with([
    ...
    {
        $insertData = [
            'encouter_id' => (int)$request->encouter_id,
            'type' => $request->type,
            'key' => 'soal',
            'value' => $request->value,
            'details' => $request->type === 'pg' ? json_encode([
        ...
        $data = EncouterDetail::create($insertData);

        event(new BreadDataAdded($dataType, $data));

        return redirect()
            ->route("voyager.encouters.edit", $data->encouter_id)
            ->with([
