...
class ExerciseDetailController extends VController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $encouterDetail = ExerciseDetail::find($id);
        if (!empty($encouterDetail->id)) {
            ...
            $encouterDetail->update($bodyExer);
        }
        ...
        return redirect()
        ->route("voyager.exercises.edit", $request->exercise_id)
        ->with([
    ...
    public function store(Request $request)
    {
        ...
        $data = ExerciseDetail::create($insertData);

        event(new BreadDataAdded($dataType, $data));

        return redirect()
            ->route("voyager.exercises.edit", $data->exercise_id)
            ->with([
