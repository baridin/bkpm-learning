...
class ExerciseController extends VController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        // get data detail
        $exerciseDetail = ExerciseDetail::select('id', 'key', 'value')->whereExerciseId($id)->get()->toJson();
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->settings !== 'manual') {
            ...
            ExerciseDetail::where('exercise_id',$data['id'])->delete();
    ...
    public function create(Request $request)
    {
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'mata_id', 'section_id'));
    }
    ...
    public function addBankSoal(Request $request, $id)
    {
        ...
        // foreach($request->bank_soal_id as $bank)
        // {
        ...
        {
            $bankSoal = BankSoal::find($bank);
            $postest = Exercise::find($id);

            ExerciseDetail::create([
                'exercise_id' => $postest->id,
                 'value' => $bankSoal->soal,
                'details' => $bankSoal->details,
                'key' => 'soal',
                'type_soal' => $bankSoal->type_soal,
                'bank_soal_id' => $bankSoal->id
            ]);
        }
