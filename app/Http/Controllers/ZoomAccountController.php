...
class ZoomAccountController extends VController
{
...
//testing commit 
    ...
    public function show(Request $request, $id)
    {
        ...
        // Get virtual class by zoom account
        $VC = VirtualClass::whereZoomAccountId($id);
        $virtualMeeting = $VC->whereType('meeting')->get();
        $virtualWebinar = $VC->whereType('webinar')->get();
