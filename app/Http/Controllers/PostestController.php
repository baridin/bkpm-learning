...
use Carbon\Carbon;
use App\PostestDetail;
use App\Postest;
use App\BankSoal;
use App\DiklatMataDiklat;

class PostestController extends VController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->settings !== 'manual') {
             PostestDetail::where('postest_id',$data['id'])->delete();
      ...
      public function addBankSoal(Request $request, $id)
    {
        ...
        PostestDetail::where(['postest_id' => $id])->delete();
    ...
    {
        $postestDetailIds = PostestDetail::whereBankSoalId($request->bank_soal_id)->pluck('id')->toArray();
        PostestDetail::destroy($postestDetailIds);
