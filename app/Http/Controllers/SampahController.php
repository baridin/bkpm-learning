...
class SampahController extends VController
{
    ...
    public function index(Request $request, $menu)
    {
        ...
        if (strlen($dataType->model_name) != 0) {
            ...
            if ($dataType->scope && $dataType->scope != '' && method_exists($model, 'scope'.ucfirst($dataType->scope))) {
                ...
                $query = $model::select('*')->onlyTrashed();
            }
        ...
        if (view()->exists("voyager::sampah.browse")) {
            $view = "voyager::sampah.browse";
        }
    ...
    public function deleteForce($menu, $id)
    {
    	if($menu == 'users')
    	{
    		$menu = 'users';
    	}
    	else if($menu == 'diklats')
    	{
    		$menu = 'diklats';
    	}
    	else if($menu == 'mata-diklats')
    	{
    		$menu = 'mata_diklats';
            $data = MataDiklat::find($id);
            if (!empty($data)) {
                delWistyaHashedId($data->wistia_hashed_id);
            }
    	}
    	else
    	{
