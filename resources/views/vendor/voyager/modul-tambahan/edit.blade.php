...
<div class="page-content edit-add container-fluid">
    <div class="row">
        <div class="col-md-12">
            <form role="form" class="form-edit-add" action="{{ route('voyager.modul-tambahan.update',$get_id->id) }}" method="POST" enctype="multipart/form-data">
                <div class="panel panel-bordered">
                    ...
                    <div class="panel-body">
                        ...
                        <input type="hidden" name="section_id" id="section_id" value="{{ $get_id->section_id  }}">
                        <input type="hidden" name="mata_diklat_id" id="mata_diklat_id" value="{{ $get_id->mata_diklat_id }}">

                        <div id="option-form" class="form-group col-md-12">

                            <label class="control-label" for="name">Judul</label> 
                            <input type="text" name="judul" id="judul" value="{{ $get_id->judul }}" class="form-control">

                        </div>

                            <div id="option-form" class="form-group col-md-12">
                                <label for="link" class="control-label">Konten</label>
                                <textarea  name="link" id="link" id="richtextdescription" class="form-control richTextBox">{{ $get_id->link }}</textarea>
                            </div>
