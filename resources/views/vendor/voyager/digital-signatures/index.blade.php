...
@section('page_title', 'Digital Signature')

@section('page_header')
    <div class="container-fluid">
        <h1 class="page-title">
            <i class="{{ __('icon') }}"></i> {{ __('Digital Signature') }}
        </h1>
    </div>
@stop
                ...
                <div class="{{$class}}">
                    <div class="panel widget center bgimage" style="margin-bottom:0;overflow:hidden;background-image:url('{{ voyager_asset('images/widget-backgrounds/03.jpg') }}');">
                        ...
                        <div class="panel-content">
                            ...
                            {{--  --}}
                            <a href="{{route('voyager.digital-signatures.show', ($r == 'absensi') ? 'virtual-class-absents' : $r)}}" class="btn btn-primary">{{__('Lihat Laporan')}}</a>
                        </div>
                    </div>
                </div>
            @endforeach
