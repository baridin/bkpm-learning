                                                    ...
                                                    @if ($action->shouldActionDisplayOnDataType())
                                                        @if ($data)
                                                            @can ($action->getPolicy(), $data)
                                                                @if ($action->getTitle() == 'Lihat')
                                                                    <a href="{{route('voyager.pretest-details.index', ['key'=>'pretest_id','filter'=>'equals','s'=>$data->getKey()])}}" target="_blank" title="{{ $action->getTitle() }}" {!! $action->convertAttributesToHtml() !!}>
