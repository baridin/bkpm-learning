            ...
            <div class="col-md-12">
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        <div>
                            <a href="{{route('voyager.references.create', ['mt_id' => $key])}}" class="btn btn-success btn-add-new">
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            <a href="javascript:" title="Hapus"
                                                ...
                                                id="delete"
                                                onclick="document.getElementById('delete_modals{!!$data->id!!}').submit()">
                                                <i class="voyager-trash"></i> <span
                                                    class="hidden-xs hidden-sm">Hapus</span>
                                            </a>
                                            <a href="{{route('voyager.references.edit', [$data->id, 'mt_id' => $key])}}" title="Ubah"
                                                class="btn btn-sm btn-primary pull-right edit">
                                                <i class="voyager-edit"></i> <span
                                                    class="hidden-xs hidden-sm">Ubah</span>
                                            </a>
                                            {{-- Single delete modal --}}
                                            <form action="{{route('voyager.references.destroy', [$data->id, 'mt_id' => $key])}}" id="delete_modals{{$data->id}}" method="POST">
                                                {{ method_field('DELETE') }}
                                                {{ csrf_field() }}
                                            </form>
                                        </td>
