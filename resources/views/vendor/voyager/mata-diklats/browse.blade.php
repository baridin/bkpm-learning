...
@section('javascript')
    ...
    <script>
        ...
        $('table#tbl-ref').on('click', 'button.delete', function (e) {
            console.log(e);

            $('#delete_form_ref')[0].action = '{{ route('voyager.'.$dataType->slug.'.destroy', ['id' => '__id']) }}'.replace('__id', $(this).data('id'));
            $('#delete_modal_ref').modal('show');
        });
