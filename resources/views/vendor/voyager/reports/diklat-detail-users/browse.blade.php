...
@section('page_header')
    <div class="container-fluid">
        <h1 class="page-title">
            <i class="{{ $dataType->icon }}"></i> Report {{ $dataType->display_name_plural }}
        </h1>
    </div>
@stop
...
@section('content')
     @php
        ...
        $angkatan_ok = 'disabled'; 
        $angkatan_check = ''; 

        $position_ok = 'disabled'; 
        $position_check = ''; 

        $instansi_ok = 'disabled'; 
        $instansi_check = '';

        $kota_ok = 'disabled'; 
        $kota_check = ''; 

        $provinsi_ok = 'disabled'; 
        $provinsi_check = '';

        $namaUser_ok = 'disabled'; 
        $namaUser_check = ''; 
        ...
        if(isset($search->inline['angkatan']))
        {
            $angkatan_ok = ''; 
            $angkatan_check = 'checked';

            $_angkatan = array_merge($_angkatan, $search->inline['angkatan']);
        }


        if(isset($search->relation['position']))
        {
            $position_ok = ''; 
            $position_check = 'checked';

            $_position = array_merge($_position, $search->relation['position']);
        }

        if(isset($search->relation['instansi']))
        {
            $instansi_ok = ''; 
            $instansi_check = 'checked';

            $_instansi = array_merge($_instansi, $search->relation['instansi']);
        }

        if(isset($search->relation['kota']))
        {
           $kota_ok = ''; 
            $kota_check = 'checked'; 
            $_kota = array_merge($_kota, $search->relation['kota']);

            $kt1 = [];

            foreach($_kota as $kt2)
            {
                array_push($kt1,"'".$kt2."'");
            }
        ...
        if(isset($search->relation['provinsi']))
        {
           $provinsi_ok = ''; 
            $provinsi_check = 'checked'; 
            $_provinsi = array_merge($_provinsi, $search->relation['provinsi']);

            $kt1 = [];

            foreach($_provinsi as $kt2)
            {
                array_push($kt1,"'".$kt2."'");
            }
        ...
        if(isset($search->relation['namaUser']))
        {
           $namaUser_ok = ''; 
            $namaUser_check = 'checked'; 
            $namaUser = array_merge($namaUser, $search->relation['namaUser']);

            $kt11 = [];

            foreach($namaUser as $kt22)
            {
        ...
        if(isset($search->relation['getNip']))
        {
           $getNip_ok = ''; 
            $getNip_check = 'checked'; 
            $_getNip = array_merge($_getNip, $search->relation['getNip']);

            $getNip1 = [];

            foreach($_getNip as $getNip2)
            {
                array_push($getNip1,"'".$getNip2."'");
            }
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select name="relation[getDiklat][]" id="diklat" multiple class="select2 form-control" {{$diklat_ok}}>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-1" style="margin-right: -80px;margin-top: 10px;z-index: 1;">
                                                        <input type="checkbox"  onclick="active_inactive('angkatan', this)" {{$angkatan_check}}>
                                                    </div>
                                                    <div class="col-md-1" style="margin-top: 10px;margin-right: 0px;">
                                                        <h4><b>angkatan</b></h4>
                                                    </div>
                                                    <div class="col-md-9">
                                                        <select name="inline[angkatan][]" id="angkatan"  multiple class="select2 form-control" {{$angkatan_ok}}>
                                                            @foreach ($datas['angkatan'] as $d)
                                                            <option value="{{$d->id}}">
                                                                {{$d->title}}
                                                            </option>
                                                            @endforeach
                                                    ...
                                                    <div class="col-md-1">
                                                        <div class="text-center" id="c_diklat" style="margin-top: 10px;">
                                                            @if (isset($search->inline['angkatan']) && count($search->inline['angkatan'])>0)
                                                            <a href="javascript:" class="badge badge-warning text-white detail">{{count($search->inline['angkatan'])}} X</a>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>  
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <select name="relation[position][]" id="position" multiple class="select2 form-control" {{$position_ok}}>
                                                            @foreach ($datas['position'] as $da)
                                                    ...
                                                    <div class="col-md-1">
                                                        <div class="text-center" id="c_diklat" style="margin-top: 10px;">
                                                            @if (isset($search->relation['position']) && count($search->relation['position'])>0)
                                                            <a href="javascript:" class="badge badge-warning text-white detail">{{count($search->relation['position'])}} X</a>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-1" style="margin-right: -80px;margin-top: 10px;z-index: 1;">
                                                        <input type="checkbox"  onclick="active_inactive('instansi', this)" {{$instansi_check}}>
                                                    </div>
                                                    <div class="col-md-1" style="margin-top: 10px;margin-right: 0px;">
                                                        <h4><b>Instansi</b></h4>
                                                    </div>
                                                    <div class="col-md-9">
                                                        <select name="relation[instansi][]" id="instansi" multiple class="select2 form-control" {{$instansi_ok}}>
                                                            @foreach ($datas['dept'] as $dap)
                                                    ...
                                                    <div class="col-md-1">
                                                        <div class="text-center" id="c_diklat" style="margin-top: 10px;">
                                                            @if (isset($search->relation['instansi']) && count($search->relation['instansi'])>0)
                                                            <a href="javascript:" class="badge badge-warning text-white detail">{{count($search->relation['instansi'])}} X</a>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-1" style="margin-right: -80px;margin-top: 10px;z-index: 1;">
                                                        <input type="checkbox"  onclick="active_inactive('kota', this)" {{$kota_check}}>
                                                    </div>
                                                    <div class="col-md-1" style="margin-top: 10px;margin-right: 0px;">
                                                        <h4><b>Kota</b></h4>
                                                    </div>
                                                    <div class="col-md-9">
                                                        <select name="relation[kota][]" id="kota" multiple class="select2 form-control" {{$kota_ok}}>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-1" style="margin-right: -80px;margin-top: 10px;z-index: 1;">
                                                        <input type="checkbox"  onclick="active_inactive('provinsi', this)" {{$provinsi_check}}>
                                                    </div>
                                                    <div class="col-md-1" style="margin-top: 10px;margin-right: 0px;">
                                                        <h4><b>provinsi</b></h4>
                                                    </div>
                                                    <div class="col-md-9">
                                                        <select name="relation[provinsi][]" id="provinsi" multiple class="select2 form-control" {{$provinsi_ok}}>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-1" style="margin-right: -80px;margin-top: 10px;z-index: 1;">
                                                        <input type="checkbox"  onclick="active_inactive('namaUser', this)" {{$namaUser_check}}>
                                                    </div>
                                                    <div class="col-md-1" style="margin-top: 10px;margin-right: 0px;">
                                                        <h4><b>namaUser</b></h4>
                                                    </div>
                                                    <div class="col-md-9">
                                                        <select name="relation[namaUser][]" id="namaUser" multiple class="select2 form-control" {{$namaUser_ok}}>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-1" style="margin-right: -80px;margin-top: 10px;z-index: 1;">
                                                        <input type="checkbox"  onclick="active_inactive('getNip', this)" {{$getNip_check}}>
                                                    </div>
                                                    <div class="col-md-1" style="margin-top: 10px;margin-right: 0px;">
                                                        <h4><b>Nip</b></h4>
                                                    </div>
                                                    <div class="col-md-9">
                                                        <select name="relation[getNip][]" id="getNip" multiple class="select2 form-control" {{$getNip_ok}}>
...
@section('javascript')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#angkatan').val([{!! implode(',',$_angkatan) !!}]);
            $('#angkatan').trigger('change');

            $('#position').val([{!! implode(',',$_position) !!}]);
            $('#position').trigger('change');

            $('#instansi').val([{!! implode(',',$_instansi) !!}]);
            $('#instansi').trigger('change');

            $('#kota').val([{!! implode(',',$_kota) !!}]);
            $('#kota').trigger('change');

            $('#provinsi').val([{!! implode(',',$_provinsi) !!}]);
            $('#provinsi').trigger('change');

            $('#namaUser').val([{!! implode(',',$namaUser) !!}]);
            $('#namaUser').trigger('change');

            $('#getNip').val([{!! implode(',',$_getNip) !!}]);
            $('#getNip').trigger('change');
