...
@section('page_header')
    <div class="container-fluid">
        ...
        {{-- <a href="{{ route('voyager.reports.order') }}" class="btn btn-primary btn-add-new">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-12">
                                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                        ...
                                        {{-- <div class="panel panel-default">
                                            <div class="panel-heading" role="tab" id="headingSurvey">
                                                <h4 class="panel-title">
                                                    <a role="button" data-toggle="collapse" data-parent="#accordion"
                                                        href="#collapseSurvey" aria-expanded="true"
                                                        aria-controls="collapseSurvey">
                                                        Survey Feedback
                                                    </a>
                                                    <div class="pull-right" id="c_diklat">
                                                        @if (isset($search->relation['getBySurvey']) && count($search->relation['getBySurvey'])>0)
                                                            <a href="javascript:" class="badge badge-warning text-white detail">{{count($search->relation['getBySurvey'])}} X</a>
                                                        @endif
                                                    </div>
                                                </h4>
                                            </div>
                                            <div id="collapseSurvey" class="panel-collapse collapse in" role="tabpanel"
                                                aria-labelledby="headingSurvey">
                                                <div class="panel-body">
                                                    @foreach ($datas['survey'] as $d)
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" value="{{$d->id}}" id="getBySurvey" name="relation[getBySurvey][]"
                                                                    @if (isset($search->relation['getBySurvey']) && in_array($d->id, $search->relation['getBySurvey']))
                                                                        checked
                                                                    @endif
                                                                >
                                                                {{$d->question}}
                                        ...
                                        @dump($search, end($search->relation['getBeetwenDate']), isset($search->relation['getBeetwenDate']))
                                        <div class="panel panel-default">
                                            <div class="panel-heading" role="tab" id="headingDate">
                                                <h4 class="panel-title">
                                                    <a class="collapsed" role="button" data-toggle="collapse"
                                                        data-parent="#accordion" href="#collapseDate" aria-expanded="false"
                                                        aria-controls="collapseDate">
                                                        Range Tanggal
                                                    </a>
                                                    <div class="pull-right" id="c_getBeetwenDate">
                                                        @if (isset($search->relation['getBeetwenDate']) && count($search->relation['getBeetwenDate'])>0 && !empty(array_shift($search->relation['getBeetwenDate'])))
                                                            <a href="javascript:" class="badge badge-warning text-white detail">
                                                                {{strftime('%d %B %Y', strtotime(array_shift($search->relation['getBeetwenDate'])))}} - {{strftime('%d %B %Y', strtotime(end($search->relation['getBeetwenDate'])))}}
                                                            </a>
                                                        @endif
                                                    </div>
                                                </h4>
                                            </div>
                                            <div id="collapseDate" class="panel-collapse collapse" role="tabpanel"
                                                aria-labelledby="headingDate">
                                                <div class="panel-body">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="getBeetwenDate">Tanggal Mulai</label>
                                                                <input type="text" name="relation[getBeetwenDate][]" id="datetimepicker1" class="form-control datepicker" type="datetime">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label for="getBeetwenDate">Tanggal Akhir</label>
                                                                <input type="text" name="relation[getBeetwenDate][]" id="datetimepicker2" class="form-control datepicker" type="datetime">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
