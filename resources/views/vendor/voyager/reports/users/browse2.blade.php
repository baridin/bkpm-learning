                                                ...
                                                <div class="panel-body">
                                                    @foreach ($datas['diklat'] as $d)
                                                        <div class="checkbox">
                                                            ...
                                                            <ul class="list-group">
                                                            @foreach ($d->diklatDetail as $dd)
                                                                <li class="list-group-item">
                                                                    <label>
                                                                        <input type="checkbox" value="{{$dd->id}}" id="getDiklatDetail" name="relation[getDiklatDetail{{$d->getKey()}}][]"
                                                                            @if (isset($search->relation["getDiklatDetail{$d->getKey()}"]) && in_array($dd->id, $search->relation["getDiklatDetail{$d->getKey()}"]))
                                                                                checked
                                                                            @endif
                                                                        >
                                                                        {{$dd->title.' - '.strftime('%Y', strtotime($dd->start_at))}}
                                                                    </label>
                                                                </li>
                                                            @endforeach
                                                            </ul>
                                            ...
                                            <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel"
                                                ...
                                                <div class="panel-body">
                                                    @foreach ($datas['detail'] as $d)
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" value="{{$d->title}}" id="detail" name="getDiklatDetail">
                                                                {{$d->title}}
                                                            </label>
                                                        </div>
                                                    @endforeach
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading" role="tab" id="headingThree">
                                                <h4 class="panel-title">
                                                    ...
                                                    <div class="pull-right" id="c_year">
                                            ...
                                            <div id="collapseThree" class="panel-collapse collapse" role="tabpanel"
                                                ...
                                                <div class="panel-body">
                                                    @foreach (['2018', '2019', '2020', '2021', '2022', '2023', '2024', '2025'] as $d)
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" value="{{$d}}" id="year" name="relation[getDiklatDetailYear][]"
                                                                    @if (isset($search->relation['getDiklatDetailYear']) && in_array($d, $search->relation['getDiklatDetailYear']))
                                                                        checked
                                                                    @endif
                                                                >
                                                                {{$d}}
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading" role="tab" id="headingThree">
                                                <h4 class="panel-title">
                                                    ...
                                                    <div class="pull-right" id="c_asn">
                                                        @if (isset($search->inline['category_id']) && count($search->inline['category_id'])>0)
                                                            <a href="javascript:" class="badge badge-warning text-white detail">{{count($search->inline['category_id'])}} X</a>
                                                        @endif
                                                    </div>
                                                </h4>
                                            </div>
                                            <div id="collapseAsn" class="panel-collapse collapse" role="tabpanel"
                                                ...
                                                <div class="panel-body">
                                                    @foreach (['NON ASN', 'ASN'] as $k =>  $d)
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" value="{{$k}}" id="asn" name="inline[category_id][]"
                                                                    @if (isset($search->inline['category_id']) && in_array($k, $search->inline['category_id']))
                                                                        checked
                                                                    @endif
                                                                >
                                                                {{$d}}
