...
@php       
        ...
        $getDiklatDetail_ok = 'disabled'; 
        $getDiklatDetail_check = ''; 
        ...
        {
            $getDiklatDetail_ok = ''; 
            $getDiklatDetail_check = 'checked';

            $_getDiklatDetail = array_merge($_getDiklatDetail, $search->relation['getDiklatDetail']);
        }
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-body">
                                               <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-1" style="margin-right: -80px;margin-top: 10px;z-index: 1;">
                                                        <input type="checkbox"  onclick="active_inactive('getDiklatDetail', this)" {{$getDiklatDetail_check}}>
                                                    </div>
                                                    <div class="col-md-1" style="margin-top: 10px;margin-right: 0px;">
                                                        <h4><b>Angkatan</b></h4>
                                                    </div>
                                                    <div class="col-md-9">
                                                        <select name="relation[getDiklatDetail][]" id="getDiklatDetail"  multiple class="select2 form-control" {{$getDiklatDetail_ok}}>
...
@section('javascript')
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#getDiklatDetail').val([{!! implode(',',$_getDiklatDetail) !!}]);
            $('#getDiklatDetail').trigger('change');
