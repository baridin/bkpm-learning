                                    ...
                                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                        <div class="panel panel-default">
                                            <div class="panel-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-1" style="margin-right: -80px;margin-top: 10px;z-index: 1;">
                                                        <input type="checkbox" onclick="active_inactive('mata-diklat', this)" {{$mata_check}}>
                                                    </div>
                                                    <div class="col-md-1" style="margin-top: 10px;margin-right: 0px;">
                                                        <h4><b>Mata Diklat</b></h4>
                                                    </div>
                                                    <div class="col-md-9">
                                                        <select id="mata-diklat" name="relation[getMataDiklat][]" class="select2 form-control" {{$mata_ok}}>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-1">
                                                        <div class="text-center" id="c_diklat" style="margin-top: 10px;">
                                                            @if (isset($search->relation['getMataDiklat']) && count($search->relation['getMataDiklat'])>0)
                                                                <a href="javascript:" class="badge badge-warning text-white detail">{{count($search->relation['getMataDiklat'])}} X</a>
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2 col-2">
                                        <div class="clearfix">
                                            ...
                                            <button class="btn btn-danger" onclick="toPDF(event)">
                                                PDF
                                            </button>
                                        </div>
                                    </div>
...
@section('javascript')
    ...
    <script>
        ...
        function toPDF(e)
        {
            ...
            window.open(`/admin/reports/pdf/{!!$slug!!}${formData}`)
        }
    </script>
@stop
