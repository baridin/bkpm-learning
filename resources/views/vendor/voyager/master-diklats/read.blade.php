            ...
            <div class="col-md-12">
                <div>
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Peserta</a></li>
                    </ul>
                        ...
                        <div role="tabpanel" class="tab-pane" id="profile">
                            <div class="table-responsive">
                                <table id="dataTable" class="table table-hover">
                                    ...
                                    <tbody>
                                        @foreach($dataTypeContent->userActive() as $data)
                                        <tr>
                                            <td><a href="{{route('voyager.users.show',$data->id)}}" target="_blank">{{$data->name}}</a></td>
                                            <td>{{$data->username}}</td>
                                            <td>{{$data->mobile}}</td>
                                        </tr>
                                        @endforeach
