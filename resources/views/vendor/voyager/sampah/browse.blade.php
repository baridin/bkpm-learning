                                                        ...
                                                        @if ($data)
                                                            @can ($action->getPolicy(), $data)
                                                                @if ($action->getTitle() == 'Restore')
                                                                    ...
                                                                    <a href="/admin/sampah/delete/{{ $menu }}/{{ $data->id }}" title="{{ $action->getTitle() }}" class="btn btn-danger">
                                                                        <i class="voyager-trash"></i> <span class="hidden-xs hidden-sm">Hapus Permanen</span>
                                                                    </a>
                                                                @elseif($action->getTitle() == 'Lihat')
                                                                    <a href="{{ $action->getRoute($dataType->name) }}" title="{{ $action->getTitle() }}" {!! $action->convertAttributesToHtml() !!}>
                                                                        <i class="{{ $action->getIcon() }}"></i> <span class="hidden-xs hidden-sm">{{ $action->getTitle() }}</span>
                                                                    </a>
                                                                @endif
