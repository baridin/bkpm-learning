                                                ...
                                                @foreach ($vbk as $kbkd => $vbkd)
                                                    <tr>
                                                        @php
                                                            ...
                                                            $url = !$is_ready ? route('voyager.encouter-bank-soal.store', $dataTypeContent->id) : route('voyager.encouter-bank-soal.delete', $dataTypeContent->id); /*delete*/
                                                        @endphp
        ...
        @if($edit)
            ...
            function check(id, en, type)
            {
                ...
                data = UJIAN
                 ...
                 $.ajax({
                    method: 'post',
                    url: '{{route('voyager.encouter-bank-soal.store', $dataTypeContent->id)}}',
                    data: {
                        bank_soal_id: data,
                    },
                    success(data)
