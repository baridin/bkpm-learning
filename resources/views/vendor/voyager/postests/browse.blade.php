                                                        ...
                                                        @if ($data)
                                                            @can ($action->getPolicy(), $data)
                                                                @if ($action->getTitle() == 'Lihat')
                                                                    <a href="{{route('voyager.postest-details.index', ['key'=>'postest_id','filter'=>'equals','s'=>$data->getKey()])}}" target="_blank" title="{{ $action->getTitle() }}" {!! $action->convertAttributesToHtml() !!}>
