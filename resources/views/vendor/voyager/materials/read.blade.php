                ...
                <div class="panel panel-bordered" style="padding-bottom:5px;">
                    ...
                    @foreach($dataType->readRows as $row)
                        ...
                        <div class="panel-body" style="padding-top:0;">
                            ...
                            @elseif($row->type == 'file')
                                @if(json_decode($dataTypeContent->{$row->field}))
                                    @foreach(json_decode($dataTypeContent->{$row->field}) as $file)
                                        ...
                                        <iframe width="800" height="400" src="{{ Storage::disk(config('voyager.storage.disk'))->url($file->download_link) ?: '' }}"></iframe>
                                        <br/>
                                    @endforeach
                                @else
                            ...
                            @if($row->field == 'wistia_hashed_link')
                            <script charset="ISO-8859-1" src="//fast.wistia.com/assets/external/E-v1.js" async></script>
                            <div class="wistia_embed wistia_async_{{ $dataTypeContent->{$row->field} }}" style="height:360px;width:640px">&nbsp;</div>
        ...
        $(function(){
            ...
            _wapiq.push(function (W) {
                window.wistiaUploader = new W.Uploader({
                    ...
                    projectId: "{!!$mata->wistia_hashed_id!!}"
                });
