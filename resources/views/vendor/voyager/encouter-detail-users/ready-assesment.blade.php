            ...
            <div class="col-md-12">
                <div class="panel panel-bordered">
                    <div class="panel-body">
                        <button class="btn btn-warning" onclick="openmodal(1)"><i class="voyager-person"></i> Peserta Yang Belum Mengerjakan Ujian</button>
...
@section('javascript')
    ...
    <div class="modal fade" id="modal-cek-remedial" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form method="get" action="/admin/get-remedial">
                    <div class="modal-header">
