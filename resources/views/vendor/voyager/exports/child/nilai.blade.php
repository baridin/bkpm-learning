        ...
        <table class="paleBlueRows">
            <thead>
                <tr>
                   ...
                   @foreach ($diklat->mataDiklat as $dm)
                        <th style="width: 15px;"><b>{{$dm->title}}</b></th>
                   @endforeach
                   <th>Total Nilai</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @foreach ($diklat->mataDiklat as $dk)
                    @php
                    $encouter = App\Encouter::where('mata_diklat_id',$dk->id)->where('diklat_id',$diklat->id)->first();
                    $cek_remedial = App\EncouterUser::where('user_id',$data->getKey())->where('encouter_id',$encouter->id)->first();
                    @endphp
                    <td>
                        {{ $cek_remedial->assesment }}
