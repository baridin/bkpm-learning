    ...
    <thead>
        <tr>
            ...
            @endforeach
             ...
             @endif
            <th>Instansi</th>
            @if($fields[0] == 'user_belongsto_position_relationship')
            <th>Jabatan</th>
            @endif
        </tr>
    </thead>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                @endforeach
                @php 
                $user = \App\User::where('id','=',$data->getKey())->first(); 
                $diklatDetail = \App\DiklatUser::where('user_id','=',$user->id)->get(); 
                @endphp
                @if($fields[0] == 'diklat')
                <td>
