...
@section('content')
<div class="event my-course dashboard">
    <div class="container">
        <div class="row">
            @include('frontend.my-course.partials.sidebar')
            <div class="col-md-9 col-sm-9 col-12">
                <div class="all-course profile">
                <h2 class="inner">Profil Saya</h2>
                </div>
                
                <div class="detail profile-step">
                <nav class="nav-justified">
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    <a class="nav-item nav-link active" id="nav-one-tab" data-toggle="tab" href="#nav-one" role="tab" aria-controls="nav-one" aria-selected="true">Biodata Diri</a>
                    <a class="nav-item nav-link" id="nav-two-tab" data-toggle="tab" href="#nav-two" role="tab" aria-controls="nav-two" aria-selected="false">Data Instansi</a>
                    {{-- <a class="nav-item nav-link" id="nav-three-tab" data-toggle="tab" href="#nav-three" role="tab" aria-controls="nav-three" aria-selected="false">Timeline</a> --}}
                    </div>
                </nav>
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="box-tab">
                        ...
                        <span class="symbol">Biodata Diri</span>
                        </div>
                        <form id="formEditProfile" method="post" action="{{route('my-course.update', $user->id)}}" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <div class="box__logo">
                                <div class="row">
                            ...
                            <div class="box-more">
                                <a href="javascript:" onclick="document.getElementById('formEditProfile').submit()"><i class="fa fa-plus"></i> SIMPAN</a>
                            </div>
                        </form>
                    </div>
                    </div>
                    <div class="tab-pane fade" id="nav-two" role="tabpanel" aria-labelledby="nav-two-tab">
                        <div class="box-tab">
                            <div class="box__title">
                            <span class="symbol">Data Instansi</span>
                            </div>
                            <form id="formEditInstnasi" method="post" action="{{route('my-course.update', $user->id)}}" enctype="multipart/form-data">
                                @csrf
                                @method('PATCH')
                                <div class="box__logo">
                                    <div class="row">
                                ...
                                <div class="box-more">
                                    <a href="javascript:" onclick="document.getElementById('formEditInstnasi').submit()"><i class="fa fa-plus"></i> SIMPAN</a>
                                </div>
                            </form>
                        </div>
                    </div>
